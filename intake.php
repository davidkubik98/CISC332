...
<body>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="alljobs.php">All Jobs</a> 
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item active"><a class="nav-link" href="intake.php">Total Intake</a></li>
                </ul>
							</li>
                </ul>
  ...
  <section class="section-margin">
    ...
    try{
        ...
        echo  "<p style='text-align:center;'>"."Number of Students: ".$studentRows;
        ...
        echo "<br>";
        echo "Total Intake: $" . (($studentRows * 50) + ($professionalRows * 100) + ($platinumSponsorRows * 10000) + ($goldSponsorRows * 5000) + ($silverSponsorRows * 3000) + ($bronzeSponsorRows * 1000))."</p>";
}
    ?>
